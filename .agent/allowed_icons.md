# Allowed Blender Icons

This file contains the list of allowed/valid icons in Blender. When defining Blender UI panels, buttons, layouts, or operators, only choose icons from this list to prevent hallucinating non-existent icons.
